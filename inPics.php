...
<?php
	...
	foreach($image as $img) //Reach to every single line <img> in the destination link
	{
		...
		$img_name = 'pics/'.basename($s); //The important step in here. If you want to get file name of image and parse it to fuction save it to your disk (or host, of course!), you have to get file name of it, not a link.
